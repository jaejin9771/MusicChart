...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("KoHo", 0, 36)); // NOI18N
        jLabel1.setText("음악 차트");

        btnStart.setText("시작");
        btnStart.setMaximumSize(new java.awt.Dimension(50, 23));
        btnStart.setMinimumSize(new java.awt.Dimension(50, 23));
