...
import com.mycompany.musicchart.controller.DBCon;
...
public class MainMenu extends javax.swing.JFrame {
    ...
    static Chart rg = new Chart("https://www.genie.co.kr/chart/top200", "td.info a.title.ellipsis", "td.info a.artist.ellipsis"); // 크롤링을 한번 요청하고 객체에 저장해 계속 정보를 씀
    static Chart rm = new Chart("https://www.melon.com/chart/index.htm", "div.wrap_song_info div.ellipsis.rank01 span a", "div.wrap_song_info div.ellipsis.rank02 span a");
    ...
    public MainMenu() {
        initComponents();
        db.connect();
        db.dbDelete("melonchart");
        db.dbDelete("geniechart");
        db.dbInput(rm, "melonchart");
        db.dbInput(rg, "geniechart");
    }
    ...
    private void initComponents() {
        ...
        Up.setText("Melon오름차순");
        Up.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UpMelonActionPerformed(evt);
            }
        });

        Down.setText("Genie오름차순");
        Down.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                UpGenieActionPerformed(evt);
            }
        });
...
//        }
    ...
    private void UpMelonActionPerformed(java.awt.event.ActionEvent evt) {
        //멜론차트에서 검색하기
        

        db.ascData(rowData,"melonchart","songName"); 
    ...
    private void UpGenieActionPerformed(java.awt.event.ActionEvent evt) {
        //지니뮤직에서 검색하기
        db.ascData(rowData,"geniechart","songName");
